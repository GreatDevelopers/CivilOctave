...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_1p67 = RealNumber('1.67'); _sage_const_4 = Integer(4); _sage_const_8 = Integer(8); _sage_const_0p40 = RealNumber('0.40'); _sage_const_0p67 = RealNumber('0.67'); _sage_const_1p = RealNumber('1.'); _sage_const_0p05 = RealNumber('0.05'); _sage_const_1p0 = RealNumber('1.0'); _sage_const_1p5 = RealNumber('1.5'); _sage_const_0p4 = RealNumber('0.4'); _sage_const_0p6 = RealNumber('0.6'); _sage_const_2p5 = RealNumber('2.5'); _sage_const_1p36 = RealNumber('1.36'); _sage_const_10 = Integer(10); _sage_const_0p55 = RealNumber('0.55'); _sage_const_16 = Integer(16); _sage_const_15 = Integer(15); _sage_const_0p10 = RealNumber('0.10'); _sage_const_100 = Integer(100)
